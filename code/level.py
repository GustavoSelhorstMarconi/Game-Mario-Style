...
class Level:
  def __init__(self, current_level, surface, create_overworld, change_coins, change_health):
    ...
    self.terrains_sprites = self.create_tile_group(terrain_layout, 'terrain')
  ...
  def horizontal_movement_collision(self):
    ...
    collidable_sprites = self.terrains_sprites.sprites() + self.crate_sprites.sprites() + self.fg_palms_sprites.sprites()
  ...
  def run(self):
    ...
    # Terrain
    self.terrains_sprites.update(self.world_shift)
    self.terrains_sprites.draw(self.display_surface)
